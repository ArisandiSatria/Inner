  ...
  Positioned bottomNavBar() {
    return Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: containerBackgroundColor, borderRadius: BorderRadius.circular(23)),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                  InkWell(onTap: () {}, child: Icon(Icons.home, color: primaryColor,)), 
                  InkWell(onTap: () {}, child: Icon(Icons.email, color: iconInActiveColor,)), 
                  InkWell(onTap: () {}, child: Icon(Icons.card_travel, color: iconInActiveColor,)), 
                  InkWell(onTap: () {}, child: Icon(Icons.favorite, color: iconInActiveColor,)), 
                ],),
              ));
  }
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: InkWell(onTap: () {},child: Icon(Icons.search, size: 32, color: primaryColor,)),
            ...
            child: InkWell(
              ...
              child: ClipRRect(
                ...
                child: Container(
                    ...
                    child: Row(
                      children: [
                        ClipRRect( borderRadius: BorderRadius.circular(18), child: Image.asset(place.imageAsset)),
                        Padding(
